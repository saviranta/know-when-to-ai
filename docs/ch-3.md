...
<svg viewBox="0 0 800 400" xmlns="http://www.w3.org/2000/svg" role="img" aria-labelledby="ch2-ill21-title">
  ...
  <text class="ch2m-band" x="400" y="295">The toolkit &mdash; twenty-six tools spread across the gates</text>

  <rect class="ch2m-rect-dashed" x="60" y="310" width="680" height="50" rx="4" />
  <text class="ch2m-sub" x="400" y="340">A palette for each gate &mdash; analytical frames at G1/G2/G4/G5, AI capability levels at G3.</text>
