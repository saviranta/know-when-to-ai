...
<svg viewBox="0 0 800 400" xmlns="http://www.w3.org/2000/svg" role="img" aria-labelledby="ch2-ill21-title">
  ...
  <text class="ch2m-band" x="400" y="295">The atlas &mdash; tools enter at G3, and only at G3</text>

  <rect class="ch2m-rect-dashed" x="60" y="310" width="680" height="50" rx="4" />
  <text class="ch2m-sub" x="400" y="340">Twenty-six tool cards; each enters the method only at G3</text>

  <line class="ch2m-arrow-dashed" x1="400" y1="310" x2="400" y2="272" />
  <polygon class="ch2m-head-dashed" points="394,272 406,272 400,266" />
</svg>
</div>
